...
function ShapePath({ shape, fill }: { shape: BotShape; fill: string }) {
  if (shape === "drop") {
    return (
      <Path
        d="M27 5C37 17 44 26 44 36c0 11-8 19-20 19S4 47 4 36C4 25 13 14 27 5Z"
        fill={fill}
      />
    );
  }
  ...
  if (shape === "soft-square") {
    return (
      <Path
        d="M10 7c8-4 28-4 36 1 6 5 7 30 1 38-6 8-31 8-39 1-7-7-6-33 2-40Z"
        fill={fill}
      />
    );
  }
  if (shape === "kite") {
    return (
      <Path
        d="M28 4c6 0 22 18 22 30 0 11-9 19-22 19S6 45 6 34C6 22 22 4 28 4Z"
        fill={fill}
      />
    );
  }
  ...
  if (shape === "cloud") {
    return (
      <Path
        d="M15 49C8 49 3 44 3 37c0-6 4-11 10-12 1-10 8-17 18-17 9 0 16 6 18 14 5 2 8 7 8 13 0 8-6 14-14 14H15Z"
        fill={fill}
      />
    );
  }
  return (
    <Path
      d="M29 4c15 0 24 8 24 23S44 52 29 52 4 43 4 28 14 4 29 4Z"
      fill={fill}
    />
  );
}
