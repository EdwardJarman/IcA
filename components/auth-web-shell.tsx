...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: "#FFFFFF", fontSize: 10, fontWeight: "900", letterSpacing: 1.5, marginBottom: 10 },
  title: { color: "#FFFFFF", fontSize: 33, lineHeight: 39, fontWeight: "900", letterSpacing: -1.1, maxWidth: 390 },
  detail: { color: "#FFFFFF", fontSize: 14, lineHeight: 21, marginTop: 11, marginBottom: 28, maxWidth: 400 },
