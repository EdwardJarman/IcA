...
const styles = StyleSheet.create({
  ...
  mark: { width: 74, height: 74, borderRadius: 28, backgroundColor: palette.cloud, alignItems: "center", justifyContent: "center", shadowColor: palette.cloud, shadowOpacity: 0.22, shadowRadius: 20, shadowOffset: { width: 0, height: 8 } },
  ...
  detail: { color: palette.cloud, textAlign: "center", fontSize: 14, lineHeight: 21, marginTop: 11, maxWidth: 335 },
  ...
  legal: { color: palette.cloud, fontSize: 10, lineHeight: 15, textAlign: "center", marginTop: 17, maxWidth: 335 },
