...
async function createAndroidChannel() { if (Platform.OS === "android") await Notifications.setNotificationChannelAsync("workroom-alerts", { name: "UmU alerts", description: "Task completions and approval requests from UmU.", importance: Notifications.AndroidImportance.HIGH, vibrationPattern: [0, 160, 110, 160], lightColor: "#77F3C4" }); }
