...
export function WorkroomProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<WorkroomContextValue>(() => ({ ready, onboardingComplete, selectedBotId, bots, messages, tasks, skills, routines, approvals, files, notifications, activity, syncStatus, selectBot: setSelectedBotId, createBot, updateBotStatus, addMessage, addTask, updateTaskStatus, addSkill, addApproval, addRoutine, toggleRoutine, resolveApproval, addFile, markNotificationsRead, addActivity, completeOnboarding: () => setOnboardingComplete(true) }), [ready, onboardingComplete, selectedBotId, bots, messages, tasks, skills, routines, approvals, files, notifications, activity, syncStatus, createBot, updateBotStatus, addMessage, addTask, updateTaskStatus, addSkill, addApproval, addRoutine, toggleRoutine, resolveApproval, addFile, markNotificationsRead, addActivity]);
