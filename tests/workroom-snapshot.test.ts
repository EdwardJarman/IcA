...
describe("workroom cloud snapshots", () => {
  it("creates an honest blank snapshot for a new authenticated account", () => {
    expect(emptyWorkroomSnapshot()).toEqual({ selectedBotId: "", onboardingComplete: false, bots: [], messages: [], tasks: [], skills: [], routines: [], approvals: [], files: [], notifications: [], activity: [] });
  });
